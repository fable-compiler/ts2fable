...
module ts =
    ...
    type Globals =
        ...
        // member __.validateLocaleAndSetLanguage(locale: string, sys: TODO_TypeLiteral, ?errors: Push<Diagnostic>): unit = jsNative
        ...
        // member __.getEffectiveTypeRoots(options: CompilerOptions, host: TODO_TypeLiteral): ResizeArray<string> option = jsNative
        ...
        // member __.createTempVariable(recordTempVariable: TODO_ParenthesizedType option): Identifier = jsNative
        ...
        // member __.createKeywordTypeNode(kind: TODO_IndexedAccessType): KeywordTypeNode = jsNative
        ...
        // member __.createMetaProperty(keywordToken: TODO_IndexedAccessType, name: Identifier): MetaProperty = jsNative
        ...
        // member __.createHeritageClause(token: TODO_IndexedAccessType, types: ReadonlyArray<ExpressionWithTypeArguments>): HeritageClause = jsNative
        ...
        // member __.visitParameterList(nodes: NodeArray<ParameterDeclaration>, visitor: Visitor, context: TransformationContext, ?nodesVisitor: TODO_TypeQuery): NodeArray<ParameterDeclaration> = jsNative
        ...
        // member __.visitEachChild<'T>(node: 'T option, visitor: Visitor, context: TransformationContext, ?nodesVisitor: TODO_TypeQuery, ?tokenVisitor: Visitor): 'T option = jsNative
        ...
        // member __.readConfigFile(fileName: string, readFile: Func<string, string option>): TODO_TypeLiteral = jsNative
        // member __.parseConfigFileTextToJson(fileName: string, jsonText: string): TODO_TypeLiteral = jsNative
        ...
        // member __.convertCompilerOptionsFromJson(jsonOptions: obj, basePath: string, ?configFileName: string): TODO_TypeLiteral = jsNative
        // member __.convertTypeAcquisitionFromJson(jsonOptions: obj, basePath: string, ?configFileName: string): TODO_TypeLiteral = jsNative
        ...
        // member __.transform<'T>(source: U2<T, ResizeArray<T>>, transformers: TODO_ArrayGeneric, ?compilerOptions: CompilerOptions): TransformationResult<'T> = jsNative
