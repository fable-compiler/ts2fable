...
module ts =
    ...
    and Globals =
        ...
        // function forEachChild<T>(node: Node, cbNode: (node: Node) => T | undefined, cbNodes?: (nodes: Node array) => T | undefined): T | undefined;
        // member __.forEachChild(node: Node, cbNode: Func<Node, 'T option>, ?cbNodeArray: Func<Node array, 'T option> -> 'T option)
